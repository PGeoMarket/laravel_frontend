...
<div style="background-image: url('{{ asset('svg/icons/harinadetrigo.svg') }}')" class="border border-gray-500 w-[18.32em] h-[19.48em] ml-4 rounded-md bg-cover bg-center relative"></div>
...
<div class="flex justify-between items-center mt-4 px-4">
  ...
  <div class="bg-gray-100 w-[20.86em] h-[15.57em] rounded-lg ml-4 mt-4">
    ...
    <p class="ml-2">Harina de trigo de alta calidad, ideal para <br> panadería y repostería. Obtén resultados <br> perfectos en tus recetas favoritas.</p>
  </div>
  ...
  <div>
    ...
    <iframe class="w-[20.86em] h-[20.86em] p-4 rounded-3xl" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1992.160176789594!2d-76.48352223851431!3d3.0082367277367377!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e307f3134b20a77%3A0xcb8ce9e4a1c72448!2sSENA%20Regional%20Cauca!5e0!3m2!1ses-419!2sco!4v1750977951386!5m2!1ses-419!2sco" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  ...
  <div>
    ...
    <div class="border border-gray-400 w-[20.86em] h-16 ml-2 rounded-lg relative mt-2">
      <img class="ml-1 mt-1 absolute w-8 h-8 rounded-full" src="{{ asset('svg/icons/userProfiel.svg') }}" alt="">
