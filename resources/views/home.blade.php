    ...
    <div class="flex justify-center">
        <div class="fixed w-[90%] flex justify-between items-center bg-background my-[-10px] py-2 z-40">
            ...
            <div class="z-50" x-data={open:false}>
                ...
                <div x-show = "open" class="bg-gray-500/50 h-full w-full fixed top-0 left-0 select-none">
                    @include('components.mapa')
                </div>
            </div>
        </div>
        <div class="bg-black/75 h-full w-full fixed z-50 top-0 left-0 select-none">
            @include('Registrarse_como')
        </div>
    </div>
