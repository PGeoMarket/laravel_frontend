...
<html lang="en">
  ...
  <body>
    <nav
      class="bg-[#f8fafc] border-b border-[#e5e7eb] px-4 py-2 height-3000 flex items-center justify-between"
    >
      <!-- logo y nombre -->
      <div class="flex items-center">
        <img
          src="{{ asset('svg/icons/logo.svg') }}"
          alt="GeoMarket Logo"
          class="cursor-pointer"
        />

        <img
          src="{{asset('svg/icons/geomarket.svg')}}"
          alt=""
      ...
      <div>
        <div class="flex items-center gap-x-2 ml-4">
          ...
          <img src="{{asset('svg/icons/menu.svg')}}" class="cursor-pointer" />
        </div>
      </div>
    </nav>
  </body>
