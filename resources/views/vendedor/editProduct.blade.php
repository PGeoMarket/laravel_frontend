...
@section('content')
   ...
   {{--  esta pantalla debe resivir cambios mas adelante usado old() --}}
            ...
            <div class="h-full  grid grid-rows-[40%_60%] overflow-scroll md:grid-cols-2 md:grid-rows-none">
                    ...
                    <div x-data="{ image: null }"
                        ...
                        <div class=" border-1 border-borde1 rounded-2xl my-3 w-fit h-auto md:max-h-[500px] mx-auto">
                            ...
                            <img src="{{ asset('img/florhuila.png') }}" class="h-full rounded-[14px]"
                                x-show="!image">
                ...
                <div class=" grid grid-rows-[auto_1fr] md:p-5">
                    ...
                    <div class="flex flex-col  h-fit space-y-4">
                        <input type="text" name="productName "
                            ...
                            placeholder="Nombre del producto" value="Arroz florhuila" required>

                        <input type="number" name="productPrice"
                            class="inputs_registro"
                            placeholder="Precio del producto" value="1000" required>
                    ...
                    <div class=" ">
                        ...
                        <textarea name="" id="" class="bg-white border-1 border-borde2 p-1 rounded-md w-full h-full"
                            placeholder="Descripcion">Arroz blanco de grano largo, ideal para acompañar cualquier comida. Suave, esponjoso y fácil de preparar.</textarea>
                    </div>
