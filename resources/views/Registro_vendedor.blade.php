  ...
  <div class="bg-white shadow-lg rounded-xl p-6 sm:p-10 w-full max-w-md relative">
    ...
    <form method="POST" action="#">
      ...
      <div class="space-y-4">
        ...
        <input type="text" name="nombre_negocio" placeholder="Nombre negocio" class="inputs_registro" required/>
        ...
        <input type="text" name="direccion" placeholder="Direccion" class="inputs_registro" required/>
